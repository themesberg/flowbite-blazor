// Inspired by MudBlazor: https://github.com/MudBlazor/MudBlazor/blob/dev/src/MudBlazor/Utilities/CssBuilder.cs
...
public struct CssBuilder
{
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(string? value, Func<bool>? when = null) => this.AddClass(value, when is not null && when());
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(Func<string?> value, Func<bool>? when = null) => this.AddClass(value, when is not null && when());
    ...
    /// <param name="when">Condition in which the CSS Class is added.</param>
    /// <returns>CssBuilder</returns>
    public CssBuilder AddClass(CssBuilder builder, Func<bool>? when = null) => this.AddClass(builder, when is not null && when());
    ...
    public CssBuilder AddClassFromAttributes(IReadOnlyDictionary<string, object> additionalAttributes) =>
        ...
        additionalAttributes.TryGetValue("class", out var c) ? AddClass(c?.ToString() ?? string.Empty) : this;
