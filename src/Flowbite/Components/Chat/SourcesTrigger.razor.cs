...
public partial class SourcesTrigger : Flowbite.Base.FlowbiteComponentBase
{
    ...
    private string BaseClasses =>
        ...
        "text-sm font-medium text-gray-700 transition hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 " +
        "dark:bg-gray-800 dark:text-gray-200";

    private string ContentId => SourcesContext.ContentId;

    private string GetChevronClasses() => SourcesContext.IsOpen ? "h-4 w-4 rotate-180 transition" : "h-4 w-4 transition";
