...
public partial class Paragraph
{
    ...
    private string GetParagraphClasses()
    {
        ...
        var classes = ElementClass.Empty()
            ...
            .Add(Weight.HasValue ? GetFontWeightClass(Weight.Value) : null)
            .Add(Leading.HasValue ? GetLineHeightClass(Leading.Value) : null)
            .Add(Align.HasValue ? GetTextAlignClass(Align.Value) : null)
            .Add(Tracking.HasValue ? GetLetterSpacingClass(Tracking.Value) : null)
            .Add(Space.HasValue ? GetWhitespaceClass(Space.Value) : null)
            .Add(Opacity.HasValue ? $"opacity-{Opacity.Value}" : null)
